...
public class CfdiServiceImpl implements CfdiService {
    ...
    @Override
    public CFDI stampInvoice(Invoice invoice) {
        ...
        final String noCertificadoSAT = "20001000000300022323";
    ...
    @Override
    public CFDI dummyStampInvoice(Invoice invoice) {
    ...
    @Override
    public CFDI getDummyCfdi(Long id) {
        return null;
    }
}
